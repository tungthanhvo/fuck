define(['./module'], function(controllers) {
    'use strict';
    controllers.controller('accountController', ['$rootScope', '$scope', '$http', '$cookieStore', 'accountService', '$location',
        function($rootScope, $scope, $http, $cookieStore, accountService, $location) {
            var _this = this;
            _this.user = {
                username: '',
                password: '',
