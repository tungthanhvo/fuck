...
// Disable weekend selection
        ...
        _this.personalInfoCancel = function () {
            ...
            _this.userInfoUpdate.married_status = _this.userInfo.married_status;
            _this.userInfoUpdate.gender = _this.userInfo.gender;
            _this.userInfoUpdate.dob = _this.userInfo.dob;
            _this.userInfoUpdate.country_code = _this.userInfo.country_code;
            _this.userInfoUpdate.nationality_code = _this.userInfo.nationality_code;
            _this.userInfoUpdate.address = _this.userInfo.address;
            _this.userInfoUpdate.mobile = _this.userInfo.mobile;
        ...
        var isValueChange = function () {
            if (_this.userInfoUpdate.last_name != _this.userInfo.last_name) {
                return true;
            }
            if (_this.userInfoUpdate.first_name != _this.userInfo.first_name) {
                return true;
            }
            if (_this.userInfoUpdate.nickname != _this.userInfo.nickname) {
                return true;
            }
            if (_this.userInfoUpdate.married_status != _this.userInfo.married_status) {
                return true;
            }
            if (_this.userInfoUpdate.gender != _this.userInfo.gender) {
                return true;
            }

            if (_this.userInfoUpdate.dob != _this.userInfo.dob) {
                return true;
            }
            if (_this.userInfoUpdate.country_code != _this.userInfo.country_code) {
                return true;
            }
            if (_this.userInfoUpdate.nationality_code != _this.userInfo.nationality_code) {
                return true;
            }
            if (_this.userInfoUpdate.address != _this.userInfo.address) {
                return true;
            }
            if (_this.userInfoUpdate.mobile != _this.userInfo.mobile) {
                return true;
            }
            if (_this.userInfoUpdate.personal_email != _this.userInfo.personal_email) {
                return true;
            }
            ...
            employeeService.getUserInfo(_this.user_id).then(function (response) {
                ...
                employeeService.updatePersonalInformationForUser(_this.user_id, _this.userInfoUpdate).then(function (response) {
                    if (response.data.code != '200') {
                        ...
                        _this.userInfo.personal_email = _this.userInfoUpdate.personal_email;
